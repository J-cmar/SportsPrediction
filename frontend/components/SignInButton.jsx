      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-auto">
        ...
        <div className="space-y-4">
          <button
            ...
            className={`w-full font-semibold py-3 px-6 rounded-lg transition-all duration-300 border border-gray-300 flex items-center justify-center gap-3 ${
              loadingProvider === "google"
                ? "bg-gray-100 text-gray-500 cursor-not-allowed"
                : "bg-white hover:bg-gray-50 text-gray-900 transform hover:scale-105 shadow-lg hover:shadow-xl"
            }`}
          >
            {loadingProvider === "google" ? (
              <>
